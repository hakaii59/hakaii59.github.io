...
title: Cyber Apocalypse CTF 2026 - Words from the past
slug: "words_from_the_past"
featured: true
tags:
  - pwnable
...
```
![stage1_success](./stage1_success.png)
...
![before_set_getpid](before_set_getpid.png)
...
![after_set_getpid](after_set_getpid.png)

Sau khi set xong pid và mục tiêu là nhảy đến one_gadget có offset (0x583f3)
![alt text]({4DFB47C5-795E-43EC-BF4B-D5F4E66045D3}.png)
Nhảy thành công!!!
## Final Exploit
